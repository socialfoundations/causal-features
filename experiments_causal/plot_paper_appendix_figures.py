        ...
        if ax_index == 0:
            ...
            if (
                ...
                barlist = ax[0, 0].bar(
                    ...
                    shift["ood_test"]
                    - eval_constant["ood_test"].values[0]
                    + 0.01,  # 0.3 for assistment and public coverage
...
for experiment_group, experiments in experiment_groups.items():
    ...
    fig.savefig(
        str(
            Path(__file__).parents[0]
            / f"plots_paper/plot_appendix_causalml_{experiment_group}.pdf"
        ),
        bbox_inches="tight",
    )
...
for experiment_group, experiments in experiment_groups.items():
    ...
    fig.savefig(
        str(
            Path(__file__).parents[0]
            / f"plots_paper/plot_appendix_anticausal_{experiment_group}.pdf"
        ),
        bbox_inches="tight",
    )
