...
COLLEGE_SCORECARD_FEATURES = FeatureList(features=[
    ...
    Feature('UGDS_2MOR', float,
            name_extended='Total share of enrollment of undergraduate degree-seeking students who are two or more races'),
    ...
    Feature('UGDS_WHITENH', float,
            name_extended='Total share of enrollment of undergraduate degree-seeking students who are white non-Hispanic'),
    Feature('UGDS_BLACKNH', float,
            name_extended='Total share of enrollment of undergraduate degree-seeking students who are black non-Hispanic'),
    ...
    Feature('UGDS_AIANOld', float,
            name_extended='Total share of enrollment of undergraduate degree-seeking students who are American Indian/Alaska Native'),
    ...
    Feature('UG_AIANOld', float,
            name_extended='Total share of enrollment of undergraduate students who are American Indian/Alaska Native'),
    ...
    Feature('NPT4_PROG', float,
            name_extended='Average net price for the largest program at the institution for program-year institutions'),
...
COLLEGE_SCORECARD_FEATURES_CAUSAL_SUBSETS = get_causal_robust(COLLEGE_SCORECARD_FEATURES_CAUSAL, target, domain)
COLLEGE_SCORECARD_FEATURES_CAUSAL_SUBSETS_NUMBER = len(COLLEGE_SCORECARD_FEATURES_CAUSAL_SUBSETS)
