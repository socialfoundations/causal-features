...
################################################################################
# Configuration for additional robustness tests
################################################################################

# for index in range(ACS_INCOME_FEATURES_RANDOM_SUBSETS_NUMBER):
#     NON_BENCHMARK_CONFIGS["acsincome_random_test_"+f"{index}"] = ExperimentConfig(
#         splitter=DomainSplitter(val_size=DEFAULT_ID_VAL_SIZE,
#                                 ood_val_size=DEFAULT_OOD_VAL_SIZE,
#                                 random_state=DEFAULT_RANDOM_STATE,
#                                 id_test_size=DEFAULT_ID_TEST_SIZE,
...
#     NON_BENCHMARK_CONFIGS["acsfoodstamps_random_test_"+f"{index}"] = ExperimentConfig(
#         splitter=DomainSplitter(val_size=DEFAULT_ID_VAL_SIZE,
#                                 ood_val_size=DEFAULT_OOD_VAL_SIZE,
#                                 random_state=DEFAULT_RANDOM_STATE,
#                                 id_test_size=DEFAULT_ID_TEST_SIZE,
...
#     NON_BENCHMARK_CONFIGS["acspubcov_random_test_"+f"{index}"] = ExperimentConfig(
#         splitter=DomainSplitter(val_size=DEFAULT_ID_VAL_SIZE,
#                                 ood_val_size=DEFAULT_OOD_VAL_SIZE,
#                                 random_state=DEFAULT_RANDOM_STATE,
#                                 id_test_size=DEFAULT_ID_TEST_SIZE,
...
#         grouper=None,
#         preprocessor_config=PreprocessorConfig(),
#         tabular_dataset_kwargs={"acs_task": "acspubcov", "name": "acspubcov_random_test_"+f"{index}",
#                                 "years": ACS_YEARS})
...
#     NON_BENCHMARK_CONFIGS["brfss_blood_pressure_random_test_"+f"{index}"] = ExperimentConfig(
#         splitter=DomainSplitter(val_size=DEFAULT_ID_VAL_SIZE,
#                                 ood_val_size=DEFAULT_OOD_VAL_SIZE,
#                                 random_state=DEFAULT_RANDOM_STATE,
#                                 id_test_size=DEFAULT_ID_TEST_SIZE,
...
#         grouper=None,
#         preprocessor_config=PreprocessorConfig(passthrough_columns=["IYEAR"]),
#         tabular_dataset_kwargs={"name": "brfss_blood_pressure_random_test_"+f"{index}",
#                                 "task": "blood_pressure",
#                                 "years": BRFSS_YEARS},
#     )
...
NON_BENCHMARK_CONFIGS["acsincome_pc"] = ExperimentConfig(
        splitter=DomainSplitter(val_size=DEFAULT_ID_VAL_SIZE,
                                ood_val_size=DEFAULT_OOD_VAL_SIZE,
                                random_state=DEFAULT_RANDOM_STATE,
                                id_test_size=DEFAULT_ID_TEST_SIZE,
...
################################################################################
# Configuration for distribution per feature
################################################################################

for index, subset in enumerate(ACS_INCOME_FEATURES_DIST):
    NON_BENCHMARK_CONFIGS["acsincome_dist_"+f"{index}"] = ExperimentConfig(
        splitter=DomainSplitter(val_size=DEFAULT_ID_VAL_SIZE,
                                ood_val_size=DEFAULT_OOD_VAL_SIZE,
                                random_state=DEFAULT_RANDOM_STATE,
                                id_test_size=DEFAULT_ID_TEST_SIZE,
...
for index, subset in enumerate(ACS_PUBCOV_FEATURES_DIST):
    NON_BENCHMARK_CONFIGS["acspubcov_dist_"+f"{index}"] = ExperimentConfig(
        splitter=DomainSplitter(val_size=DEFAULT_ID_VAL_SIZE,
                                ood_val_size=DEFAULT_OOD_VAL_SIZE,
                                random_state=DEFAULT_RANDOM_STATE,
                                id_test_size=DEFAULT_ID_TEST_SIZE,
...
for index, subset in enumerate(ACS_UNEMPLOYMENT_FEATURES_DIST):
    NON_BENCHMARK_CONFIGS["acsunemployment_dist_"+f"{index}"] = ExperimentConfig(
        splitter=DomainSplitter(val_size=DEFAULT_ID_VAL_SIZE,
                                ood_val_size=DEFAULT_OOD_VAL_SIZE,
                                random_state=DEFAULT_RANDOM_STATE,
                                id_test_size=DEFAULT_ID_TEST_SIZE,
...
for index, subset in enumerate(ACS_FOODSTAMPS_FEATURES_DIST):
    NON_BENCHMARK_CONFIGS["acsfoodstamps_dist_"+f"{index}"] = ExperimentConfig(
        splitter=DomainSplitter(val_size=DEFAULT_ID_VAL_SIZE,
                                ood_val_size=DEFAULT_OOD_VAL_SIZE,
                                random_state=DEFAULT_RANDOM_STATE,
                                id_test_size=DEFAULT_ID_TEST_SIZE,
